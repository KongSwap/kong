...
# Step 2: Alice places activation bet (3000 KONG) on "No"
section "Step 2: Alice placing activation bet (3000 KONG) on 'No'"
...
echo -e "${CMD_COLOR}Alice placing activation bet on 'No'...${RESET}"
run_dfx "dfx canister call prediction_markets_backend place_bet \"(\$MARKET_ID : nat, 1 : nat, \$ACTIVATION_FEE : nat, opt \\\"\${KONG_LEDGER}\\\")\"" "Placing bet"
