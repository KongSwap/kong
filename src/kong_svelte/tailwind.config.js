    ...
    extend: {
      ...
      colors: {
        ...
        kong: {
          ...
          // Swap colors
          "swap-container-bg": "rgb(var(--swap-container-bg) / <alpha-value>)",
          "swap-input-bg": "rgb(var(--swap-input-bg) / <alpha-value>)",
          "swap-input-border": "rgb(var(--swap-input-border) / <alpha-value>)",
          "swap-input-hover-border": "rgb(var(--swap-input-hover-border) / <alpha-value>)",
          "swap-input-focus-border": "rgb(var(--swap-input-focus-border) / <alpha-value>)",
          "swap-button-bg": "rgb(var(--swap-button-bg) / <alpha-value>)",
          "swap-button-hover-bg": "rgb(var(--swap-button-hover-bg) / <alpha-value>)",
          "swap-button-disabled-bg": "rgb(var(--swap-button-disabled-bg) / <alpha-value>)",
          "swap-button-error-bg": "rgb(var(--swap-button-error-bg) / <alpha-value>)",
          "swap-divider": "rgb(var(--swap-divider-color) / <alpha-value>)",
      ...
      borderRadius: {
        ...
        'swap-container-roundness': 'var(--swap-container-roundness, 1rem)',
      },
    },
  },
  plugins: [
