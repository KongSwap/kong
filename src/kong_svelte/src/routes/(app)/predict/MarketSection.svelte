  ...
  {:else}
    <div class="grid {gridColumnClasses} gap-3 sm:gap-4">
      {#each markets as market (market.id)}
        <Panel
          className="relative !p-0 {isMarketResolved(market)
            ? 'opacity-100'
            : ''} group hover:bg-kong-bg-dark/10 transition-all duration-200 flex flex-col !min-h-[250px]"
        >
          <!-- Card content -->
          <div class="relative flex flex-col h-full">
            ...
            {#if market.image_url.length != 0}
              <div
                class="relative h-32 bg-black {$panelRoundness} rounded-b-none"
              >
                <img
                  src={market.image_url}
                  alt="Category Icon"
                  class="object-cover max-h-32 w-full bg-black bg-blend-overlay opacity-30"
                />
                <div class="flex items-start mt-1">
                  <!-- Title -->
                  <div class="w-full absolute top-5 left-4">
                    <button
                      class="sm:text-lg tracking-tight font-bold flex justify-between text-kong-text-primary text-left group-hover:text-kong-primary transition-colors relative w-full"
            ...
            <div class="px-4 pt-2 pb-4">
                    ...
                    {#if getYesNoIndices(market).yesIndex !== -1}
                      ...
                      >
                        ...
                        >
                          ...
                          <span
                            class="text-kong-accent font-bold text-xs whitespace-nowrap flex flex-col items-center"
                          >
                            {calculatePercentage(
                            ...
                            <div
                              class="h-1 w-12 bg-kong-bg-light rounded-full mt-1"
                            >
                              <div
                                class="h-1 bg-kong-accent-green/50 rounded-full transition-all"
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                class="h-1 bg-kong-accent-red/50 rounded-full transition-all"
                                style:width={`${calculatePercentage(
                                  market.outcome_pools[noIndex],
                                  market.outcome_pools.reduce(
                                    (acc, pool) => acc + Number(pool || 0),
                ...
                {:else}
                  ...
                  >
                    {#each market.outcomes as outcome, i}
                      <div
                        class="relative rounded {!isMarketExpiredUnresolved(
                          market,
                        ) && !isMarketResolved(market)
                      ...
                      >
                        <button
                          class="h-8 sm:h-8 hover:bg-white/10 rounded px-2 py-5 transition-colors relative w-full {isMarketResolved(
                            market,
                        ...
                        >
                          ...
                          >
                            <div class="flex items-center gap-2 min-w-0">
                              <span
                                class="font-medium text-kong-text-primary text-base truncate"
                                >{outcome}</span
                              >
                            ...
                            >
                              <div
                                class="text-kong-accent font-bold text-xs sm:text-sm whitespace-nowrap flex flex-col items-center"
                              >
                                {calculatePercentage(
              ...
              <!-- Category and time information moved to bottom -->
                <div
                  class="flex flex-wrap items-center justify-between gap-1.5 sm:gap-2 mt-2 px-1 border-t border-kong-border pt-2"
                >
