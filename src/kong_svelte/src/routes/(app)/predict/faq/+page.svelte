<script lang="ts">
  import { ArrowLeft, HelpCircle, Shield, Clock, Coins, Users, Menu, X } from "lucide-svelte";
  ...
  let showMobileGlossary = $state(false);
</script>
...
<div class="text-kong-text-primary">
  ...
  <div class="max-w-7xl mx-auto px-4 pb-8">
    ...
    <div class="lg:hidden mb-4 sticky top-16 z-20 bg-kong-bg-primary pb-2">
      <ButtonV2
        onclick={() => showMobileGlossary = true}
        theme="secondary"
        variant="outline"
        size="sm"
        className="w-full"
    ...
    <!-- Mobile Glossary Overlay -->
    {#if showMobileGlossary}
      <div class="fixed inset-0 z-50 lg:hidden">
        <!-- Backdrop -->
        <div 
          class="absolute inset-0 bg-black/50 backdrop-blur-sm"
          onclick={() => showMobileGlossary = false}
        ></div>
        
        <!-- Sidebar -->
        <div class="absolute left-0 top-0 h-full w-80 max-w-[90vw] bg-kong-bg-primary overflow-y-auto">
          <div class="p-4">
            <div class="flex items-center justify-between mb-4">
              <h3 class="text-lg font-semibold text-kong-text-primary">Glossary</h3>
              <ButtonV2
                onclick={() => showMobileGlossary = false}
                theme="secondary"
                variant="transparent"
            ...
            <div onclick={() => showMobileGlossary = false}>
              <GlossarySidebar />
            </div>
          </div>
        </div>
