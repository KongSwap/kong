...
// Default values
const defaultTitle = process.env.DFX_NETWORK === 'ic' ? 'KongSwap | Leading Multi-Chain DEX on Internet Computer' : 'KongSwap [DEV]';
...
const defaultImage = 'https://www.kongswap.io/images/banner.webp';
...
const routeMetadata = {
  ...
  '/predict': {
    ...
    image: 'https://www.kongswap.io/images/predictionmarket-og.png'
  },
  '/swap': {
...
export const load: LayoutServerLoad = ({ url }) => {
  ...
  // Use the proper origin for production
  const origin = process.env.DFX_NETWORK === 'ic' ? 'https://www.kongswap.io' : url.origin;
