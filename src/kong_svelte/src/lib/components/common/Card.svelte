...
{#if onClick}
  <button
    class="w-full text-left bg-kong-bg-secondary rounded-kong-roundness border border-kong-border/60 transition-all duration-200 overflow-hidden {isHighlighted
