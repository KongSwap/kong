...
{#if show}
<div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-md" 
     transition:fade
            ...
            {#each sortedTokens as token}
                ...
                >
                    ...
                    <div class="flex-1 text-left">
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">{token.name}</div>
                    </div>
                </button>
            {/each}
        </div>
