...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ckpepe_ledger/index.js";
...
const actorckPEPE = createActorContext();
export const useCKPEPEBackend = createUseActorHook(actorckPEPE);

const CKPEPEActor = ({ children }) => {
