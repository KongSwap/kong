...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/dolr_ledger/index.js";
...
const actorDOLR = createActorContext();
export const useDOLRBackend = createUseActorHook(actorDOLR);

const DOLRActor = ({ children }) => {
