...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/gldgov_ledger/index.js";
...
const actorGLDGov = createActorContext();
export const useGLDGovBackend = createUseActorHook(actorGLDGov);

const GLDGovActor = ({ children }) => {
