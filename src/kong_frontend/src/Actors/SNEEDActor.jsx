...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/sneed_ledger/index.js";
...
const actorSNEED = createActorContext();
export const useSNEEDBackend = createUseActorHook(actorSNEED);

const SNEEDActor = ({ children }) => {
