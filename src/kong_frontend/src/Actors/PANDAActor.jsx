...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/panda_ledger/index.js";
...
const actorPANDA = createActorContext();
export const usePANDABackend = createUseActorHook(actorPANDA);

const PANDAActor = ({ children }) => {
