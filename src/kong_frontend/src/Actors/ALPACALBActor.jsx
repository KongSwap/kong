...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/alpacalb_ledger/index.js";
...
const actorALPACALB = createActorContext();
export const useALPACALBBackend = createUseActorHook(actorALPACALB);

const ALPACALBActor = ({ children }) => {
