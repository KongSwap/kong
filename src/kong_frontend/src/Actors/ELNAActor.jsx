...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/elna_ledger/index.js";
...
const actorELNA = createActorContext();
export const useELNABackend = createUseActorHook(actorELNA);

const ELNAActor = ({ children }) => {
