...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/nd64_ledger/index.js";
...
const actorND64 = createActorContext();
export const useND64Backend = createUseActorHook(actorND64);

const ND64Actor = ({ children }) => {
