...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ntn_ledger/index.js";
...
const actorNTN = createActorContext();
export const useNTNBackend = createUseActorHook(actorNTN);

const NTNActor = ({ children }) => {
