...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/dogmi_ledger/index.js";
...
const actorDOGMI = createActorContext();
export const useDOGMIBackend = createUseActorHook(actorDOGMI);

const DOGMIActor = ({ children }) => {
