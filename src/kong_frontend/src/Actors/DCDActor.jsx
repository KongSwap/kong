...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/dcd_ledger/index.js";
...
const actorDCD = createActorContext();
export const useDCDBackend = createUseActorHook(actorDCD);

const DCDActor = ({ children }) => {
