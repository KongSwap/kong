...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/burn_ledger/index.js";
...
const actorBURN = createActorContext();
export const useBURNBackend = createUseActorHook(actorBURN);

const BURNActor = ({ children }) => {
