...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/dod_ledger/index.js";
...
const actorDOD = createActorContext();
export const useDODBackend = createUseActorHook(actorDOD);

const DODActor = ({ children }) => {
