...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ditto_ledger/index.js";
...
const actorDITTO = createActorContext();
export const useDITTOBackend = createUseActorHook(actorDITTO);

const DITTOActor = ({ children }) => {
