...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/exe_ledger/index.js";
...
const actorEXE = createActorContext();
export const useEXEBackend = createUseActorHook(actorEXE);

const EXEActor = ({ children }) => {
