...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/mcs_ledger/index.js";
...
const actorMCS = createActorContext();
export const useMCSBackend = createUseActorHook(actorMCS);

const MCSActor = ({ children }) => {
