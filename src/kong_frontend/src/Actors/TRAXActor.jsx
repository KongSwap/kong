...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/trax_ledger/index.js";
...
const actorTRAX = createActorContext();
export const useTRAXBackend = createUseActorHook(actorTRAX);

const TRAXActor = ({ children }) => {
