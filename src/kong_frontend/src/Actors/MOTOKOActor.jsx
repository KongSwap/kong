...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/motoko_ledger/index.js";
...
const actorMOTOKO = createActorContext();
export const useMOTOKOBackend = createUseActorHook(actorMOTOKO);

const MOTOKOActor = ({ children }) => {
