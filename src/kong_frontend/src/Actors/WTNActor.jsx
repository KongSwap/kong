...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/wtn_ledger/index.js";
...
const actorWTN = createActorContext();
export const useWTNBackend = createUseActorHook(actorWTN);

const WTNActor = ({ children }) => {
