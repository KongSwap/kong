import {
  ...
  import {
    canisterId,
    idlFactory,
  } from "../../../declarations/ckusdc_ledger/index.js";
  ...
  const actorCkusdc = createActorContext();
  export const useCkusdcBackend = createUseActorHook(actorCkusdc);
  
  const CkusdcActor = ({ children }) => {
