...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/fpl_ledger/index.js";
...
const actorFPL = createActorContext();
export const useFPLBackend = createUseActorHook(actorFPL);

const FPLActor = ({ children }) => {
