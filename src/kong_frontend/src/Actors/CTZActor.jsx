...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ctz_ledger/index.js";
...
const actorCTZ = createActorContext();
export const useCTZBackend = createUseActorHook(actorCTZ);

const CTZActor = ({ children }) => {
