...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/nicp_ledger/index.js";
...
const actorNICP = createActorContext();
export const useNICPBackend = createUseActorHook(actorNICP);

const NICPActor = ({ children }) => {
