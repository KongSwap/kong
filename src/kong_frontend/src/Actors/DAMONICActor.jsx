...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/damonic_ledger/index.js";
...
const actorDAMONIC = createActorContext();
export const useDAMONICBackend = createUseActorHook(actorDAMONIC);

const DAMONICActor = ({ children }) => {
