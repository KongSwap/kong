...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/owl_ledger/index.js";
...
const actorOWL = createActorContext();
export const useOWLBackend = createUseActorHook(actorOWL);

const OWLActor = ({ children }) => {
