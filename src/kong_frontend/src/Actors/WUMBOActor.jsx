...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/wumbo_ledger/index.js";
...
const actorWUMBO = createActorContext();
export const useWUMBOBackend = createUseActorHook(actorWUMBO);

const WUMBOActor = ({ children }) => {
