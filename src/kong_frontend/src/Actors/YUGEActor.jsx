...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/yuge_ledger/index.js";
...
const actorYUGE = createActorContext();
export const useYUGEBackend = createUseActorHook(actorYUGE);

const YUGEActor = ({ children }) => {
