...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ogy_ledger/index.js";
...
const actorOGY = createActorContext();
export const useOGYBackend = createUseActorHook(actorOGY);

const OGYActor = ({ children }) => {
