...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/bob_ledger/index.js";
...
const actorBOB = createActorContext();
export const useBOBBackend = createUseActorHook(actorBOB);

const BOBActor = ({ children }) => {
