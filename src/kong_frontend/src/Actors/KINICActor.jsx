...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/kinic_ledger/index.js";
...
const actorKINIC = createActorContext();
export const useKINICBackend = createUseActorHook(actorKINIC);

const KINICActor = ({ children }) => {
