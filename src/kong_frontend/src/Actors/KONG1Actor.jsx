...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/kong1_ledger/index.js";
...
const actorKONG1 = createActorContext();
export const useKONG1Backend = createUseActorHook(actorKONG1);

const KONG1Actor = ({ children }) => {
