...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/clown_ledger/index.js";
...
const actorCLOWN = createActorContext();
export const useCLOWNBackend = createUseActorHook(actorCLOWN);

const CLOWNActor = ({ children }) => {
