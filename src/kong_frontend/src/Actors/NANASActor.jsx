...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/nanas_ledger/index.js";
...
const actorNANAS = createActorContext();
export const useNANASBackend = createUseActorHook(actorNANAS);

const NANASActor = ({ children }) => {
