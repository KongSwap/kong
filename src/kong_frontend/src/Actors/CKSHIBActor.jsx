...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/ckshib_ledger/index.js";
...
const actorckSHIB = createActorContext();
export const useCKSHIBBackend = createUseActorHook(actorckSHIB);

const CKSHIBActor = ({ children }) => {
