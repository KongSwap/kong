...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/dkp_ledger/index.js";
...
const actorDKP = createActorContext();
export const useDKPBackend = createUseActorHook(actorDKP);

const DKPActor = ({ children }) => {
