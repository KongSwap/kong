...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/chat_ledger/index.js";
...
const actorCHAT = createActorContext();
export const useCHATBackend = createUseActorHook(actorCHAT);

const CHATActor = ({ children }) => {
