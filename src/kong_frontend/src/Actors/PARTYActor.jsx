...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/party_ledger/index.js";
...
const actorPARTY = createActorContext();
export const usePARTYBackend = createUseActorHook(actorPARTY);

const PARTYActor = ({ children }) => {
