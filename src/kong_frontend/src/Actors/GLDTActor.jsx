...
import {
    canisterId,
    idlFactory,
} from "../../../declarations/gldt_ledger/index.js";
...
const actorGLDT = createActorContext();
export const useGLDTBackend = createUseActorHook(actorGLDT);

const GLDTActor = ({ children }) => {
