...
impl AddPoolReply {
    pub fn new(add_pool_tx: &AddPoolTx) -> Self {
        Self::new_with_tx_id(add_pool_tx.tx_id, add_pool_tx)
    }

    pub fn new_with_tx_id(tx_id: u64, add_pool_tx: &AddPoolTx) -> Self {
