...
const ALCHEMY_URL_MAINNET: &str =
    "https://solana-mainnet.g.alchemy.com/v2/6qMktYcIX31yLkrwN403Q4E2BmK2z3W9";
...
impl SolanaRpcClient {
    ...
    pub async fn make_rpc_call(&self, method: &str, params: Value) -> Result<Value> {
        ...
        for _ in 0..10 {
            ...
            let response =
                match http_request_with_closure(request, 50_000_000_000u128, |response| response)
                    .await
                {
