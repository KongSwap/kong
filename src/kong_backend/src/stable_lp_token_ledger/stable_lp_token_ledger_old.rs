...
pub struct StableLPTokenLedgerIdOld(pub u64);

impl Storable for StableLPTokenLedgerIdOld {
...
pub struct StableLPTokenLedgerOld {
    pub lp_token_id: u64, // unique id (same as StableLPTokenLedgerIdOld) for LP_TOKEN_LEDGER
...
impl Storable for StableLPTokenLedgerOld {
    fn to_bytes(&self) -> std::borrow::Cow<[u8]> {
