...
export const getCanisterId = (name, network) => {
...
export const deployCanister = (canister, network, options = {}) => {
...
export const deployBackendCanisters = (network) => {
...
export const deployInternetIdentity = (network) => {
    if (network === 'local') {
...
export const deployFrontend = (network) => {
...
export const deployFaucet = async (network) => {
    if (network !== 'local' && network !== 'staging')
        return;
